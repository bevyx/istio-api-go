...
type ServiceEntry_Location string

const (
	// Signifies that the service is external to the mesh. Typically used
	// to indicate external services consumed through APIs.
	ServiceEntry_MESH_EXTERNAL ServiceEntry_Location = "MESH_EXTERNAL"
	// Signifies that the service is part of the mesh. Typically used to
	// indicate services added explicitly as part of expanding the service
	// mesh to include unmanaged infrastructure (e.g., VMs added to a
	// Kubernetes based service mesh).
	ServiceEntry_MESH_INTERNAL ServiceEntry_Location = "MESH_INTERNAL"
)
...
type ServiceEntry_Resolution string
...
const (
	...
	ServiceEntry_DNS ServiceEntry_Resolution = "DNS"
)
...
type ServiceEntrySpec struct {
	...
	// or part of the mesh.
	Location ServiceEntry_Location `json:"location,omitempty"`
	// REQUIRED: Service discovery mode for the hosts. Care must be taken
	// when setting the resolution mode to NONE for a TCP port without
	// accompanying IP addresses. In such cases, traffic to any IP on
	// said port will be allowed (i.e. 0.0.0.0:<port>).
	Resolution ServiceEntry_Resolution `json:"resolution,omitempty"`
...
// ServiceEntry is the Schema for the ServiceEntrys API
